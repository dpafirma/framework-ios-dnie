...
#line 208
  if (!([EsGobJmulticardConnectionCwa14890Cwa14890Connection_class_() isInstance:[self getConnection]])) {
    @try {
      self->rawConnection_ = EsGobJmulticardCardDnieDnieNfc_getPaceConnectionWithEsGobJmulticardConnectionApduConnection_withEsGobJmulticardCryptoHelper_PaceChannelHelper_(self,
#line 211
      [self getConnection],
#line 212
...
#line 229
    @try {
      [self setConnectionWithEsGobJmulticardConnectionApduConnection:self->rawConnection_];
    }
...
#line 248
    [self setConnectionWithEsGobJmulticardConnectionApduConnection:[((id<EsGobJmulticardConnectionApduConnection>) nil_chk([self getConnection])) getSubConnection]];
...
#line 153
    EsGobJmulticardCryptoHelper_PaceChannelHelper *channelHelper = [((EsGobJmulticardCryptoHelper *) nil_chk(cryptoHelper)) getPaceChannelHelperWithEsGobJmulticardAsn1IcaoCardAccess:new_EsGobJmulticardAsn1IcaoCardAccess_initWithEsGobJmulticardAsn1IcaoCardAccess_PaceAlgorithm_withEsGobJmulticardAsn1IcaoCardAccess_PaceAlgorithmParam_withEsGobJmulticardDigestAlgorithm_(JreLoadEnum(EsGobJmulticardAsn1IcaoCardAccess_PaceAlgorithm, PACE_ECDH_GM_AES_CBC_CMAC_128), JreLoadEnum(EsGobJmulticardAsn1IcaoCardAccess_PaceAlgorithmParam, BRAINPOOL_256_R1), JreLoadEnum(EsGobJmulticardDigestAlgorithm, SHA1)) withEsGobJmulticardApduIso7816fourPacePaceChat:
#line 159
    nil];
    
#line 161
    EsGobJmulticardConnectionPaceSecureMessaging *sm = [((EsGobJmulticardCryptoHelper_PaceChannelHelper *) nil_chk(channelHelper)) openPaceChannelWithByte:(jbyte) (jint) 0x00 withEsGobJmulticardCardIcaoWirelessInitializer:paceInitializer withEsGobJmulticardConnectionApduConnection:con];
